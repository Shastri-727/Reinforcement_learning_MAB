...
import numpy as np
from src.contentPersonalizationBandit import ContentPersonalizationBandit
from src.contentPersonalizationBandit_Solvers import Solver, EpsilonGreedy, UCB1, BayesianUCB, ThompsonSampling
...
def experiment(K, N):
    ...
    for solver in test_solvers:
        ...
        solver.run(N)
    plot_results(test_solvers, names, "../Results/personalisation_results_K{}_N{}.png".format(K, N))
